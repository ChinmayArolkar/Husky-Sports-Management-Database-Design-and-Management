...
INSERT INTO `coach` VALUES (1001,'Khaled Bugrara','21','NEU','Table Tennis',5),(1002,'Yusuf Ozbek','20','Huskies','Baseball',5),(1003,'John Blekney','21','NEU Juniors','Baseball',5),(1004,'Laura Mayer','15','BU Juniors','Baseball',4),(1005,'Alex Jain','19','BU','Table Tennis',4),(1006,'Steve Gupta','10','Redsox','Baseball',4);
...
--
-- Temporary view structure for view `findcoach`
--

DROP TABLE IF EXISTS `findcoach`;
/*!50001 DROP VIEW IF EXISTS `findcoach`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `findcoach` AS SELECT 
 1 AS `TeamID`,
 1 AS `TeamName`,
 1 AS `NoOfPlayers`,
 1 AS `CoachName`*/;
...
INSERT INTO `matches` VALUES (1,'2018/12/20','Huskies','Red Sox','pending',10000,100,1,1,10,11,2000,20,'00:50:00',2000,2000),(2,'2018/12/13','NEU Juniors','BU Juniors','NEU Juniors Won',900,40,2,2,12,13,2000,21,'00:50:00',2000,2000),(3,'2018/12/15','NEU','BU','Delayed',1200,150,1,3,14,15,2001,20,'00:40:00',2001,2001);
...
INSERT INTO `players` VALUES (100,'Chinmay Arolkar','Baseball','Huskies','Batter',5,72,'M'),(101,'Abhishek Kamble','Baseball','Huskies','Catcher',4,55,'M'),(102,'Swapnil Deshpande','Baseball','Huskies','First Base Coach',5,45,'M'),(103,'Yash Shinde','Baseball','Huskies','First Baseman',3,56,'M'),(104,'Sumit Anglekar','Baseball','Huskies','Short Stop',5,67,'M'),(105,'Apoorva Dudhe','Baseball','Huskies','Left Fielder',4,78,'M'),(200,'Ankita Roy','Baseball','Red Sox','Batter',5,45,'F'),(201,'Sharvari  Narendra','Baseball','Red Sox','Catcher',3,56,'F'),(202,'Arpita Gaonkar','Baseball','Red Sox','First Base Coach',4,55,'F'),(203,'Vidushi Garg','Baseball','Red Sox','First Baseman',4,44,'F'),(204,'Mrinal Roy','Baseball','Red Sox','Short Stop',4,47,'F'),(205,'Shivani Sherasiya','Baseball','Red Sox','Left Fielder',5,49,'F'),(300,'Mohit  Ambre','Table Tennis','NEU','Player 1',5,72,'M'),(301,'Viraj Jani','Table Tennis','NEU','Player2',5,71,'M'),(400,'Chirag Marathe','Table Tennis','BU','Player 1',4,66,'M'),(401,'Varun Bhagde','Table Tennis','BU','Player2',4,67,'M'),(500,'Shashank Sahu','Baseball','NEU Juniors','Batter',4,55,'M'),(501,'Shubham Mehta','Baseball','NEU Juniors','Catcher',5,45,'M'),(502,'Rushikesh Parab','Baseball','NEU Juniors','First Base Coach',3,56,'M'),(503,'Kaustubh Chavan','Baseball','NEU Juniors','First Baseman',4,67,'M'),(504,'Anirudh Raman','Baseball','NEU Juniors','Short Stop',4,78,'M'),(505,'Yashoman Apte','Baseball','NEU Juniors','Left Fielder',4,45,'M'),(600,'Ria Rajput','Baseball','BU Juniors','Batter',5,45,'F'),(601,'Aarohi Mehta','Baseball','BU Juniors','Catcher',3,56,'F'),(602,'Pallavi Dalvi','Baseball','BU Juniors','First Base Coach',4,55,'F'),(603,'Nikita Gawde','Baseball','BU Juniors','First Baseman',4,44,'F'),(604,'Nikki','Baseball','BU Juniors','Short Stop',4,47,'F'),(605,'Jessica','Baseball','BU Juniors','Left Fielder',5,49,'F');
...
INSERT INTO `seats` VALUES (1,0,'Regular',10,1,1),(2,1,'Regular',10,1,NULL),(3,1,'Regular',10,1,NULL),(4,1,'Premium',8,1,NULL),(5,1,'Premium',8,1,NULL);
...
INSERT INTO `team` VALUES (10,'Huskies','6',2000),(11,'Red Sox','6',2000),(12,'NEU Juniors','6',2000),(13,'BU Juniors','6',2000),(14,'NEU','2',2001),(15,'BU','2',2001);
...
INSERT INTO `team_has_coach` VALUES (14,2001,1001),(10,2000,1002),(12,2000,1003),(13,2000,1004),(15,2001,1005),(11,2000,1006);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `BookSeat` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `BookSeat`(IN Cust int, IN seat int)
BEGIN
update seats
set Availability=0
where SeatsID=seat;
...
set BookedBy=Cust
where SeatsID=seat;
select SeatsID, Availability, SeatType, Price, Name, Gender, City, Zip, ContactNo, EmailID from seats inner join customer on seats.BookedBy=customer.CustomerID;
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `CreateSportsHead` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `CreateSportsHead`(IN user_nm CHAR(20), IN user_ps CHAR(20))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllPlayers`(IN TID int)
BEGIN
   SELECT 
...
--
-- Final view structure for view `findcoach`
--
...
/*!50001 VIEW `findcoach` AS select `t`.`TeamID` AS `TeamID`,`t`.`TeamName` AS `TeamName`,`t`.`NoOfPlayers` AS `NoOfPlayers`,`co`.`CoachName` AS `CoachName` from ((`team` `t` join `team_has_coach` `c` on((`t`.`TeamID` = `c`.`Team_TeamID`))) join `coach` `co` on((`c`.`Coach_CoachID` = `co`.`CoachID`))) */;
...
-- Dump completed on 2018-12-14  3:45:56
